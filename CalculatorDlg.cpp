...
void CCalculatorDlg::OnButtonMutiply() 
{
	// TODO: Add your control notification handler code here
	Calculate(); 
	m_operator='*';
...
void CCalculatorDlg::OnButtonReci() 
{
	// TODO: Add your control notification handler code here
...
void CCalculatorDlg::OnButtonSqrt() 
{
	// TODO: Add your control notification handler code here
		if(m_second<0)
	{	printf("除数不能为负数：");exit(0);}
	m_second=sqrt(m_second);
	UpdateDisplay(m_second);
}

void CCalculatorDlg::Calculate(void)
{
...
double CCalculatorDlg::UpdateDisplay(double IVal)
{
